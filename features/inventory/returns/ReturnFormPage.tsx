...
export default function ReturnFormPage() {
  ...
  const handleSaveDraft = () => {
    console.log("Save draft return voucher", {
      fromDepartment,
      reason,
      notes,
      lineItems,
  ...
  const handleSubmit = () => {
    console.log("Submit return voucher", {
      fromDepartment,
      reason,
      notes,
      lineItems,
  ...
  return (
    ...
    >
      <PageHeader
        title="Create Return Voucher"
        subtitle="Return materials from departments to stores"
        breadcrumbs={[
          { label: "Inventory", href: "/inventory" },
          { label: "Return Vouchers", href: "/inventory/returns" },
          { label: "Create" },
        ]}
      />

      {/* Return Details */}
      <FormCard title="Return Details" variant="teal-header">
        <div
          style={{
            display: "flex",
            flexWrap: "wrap",
        ...
        >
          <div style={fieldGroupStyle}>
            <label style={labelStyle}>From Department *</label>
            <select
              style={selectStyle}
          ...
          <div style={{ ...fieldGroupStyle, flexBasis: "100%" }}>
            ...
            <textarea
              ...
              placeholder="Describe the reason for returning these materials..."
            />
          </div>
          <div style={{ ...fieldGroupStyle, flexBasis: "100%" }}>
          ...
          {lineItems.map((item, index) => (
            ...
            >
              ...
              <select
                ...
                onChange={(e) =>
                  handleItemChange(index, "toLocation", e.target.value)
                }
              >
