...
export default function AdjustmentDetailPage() {
  const [status] = useState<DocumentStatus>("POSTED");
  ...
  return (
    ...
    >
      ...
      <TransactionLayout
        ...
        subtitle="Stock quantity and value adjustment"
        status={status}
          ...
          <FormCard title="Adjustment Details">
            ...
            >
              ...
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                >
                  Cycle count discrepancy found during weekly inventory audit.
                </div>
              </div>
            </div>
          </FormCard>
              ...
              <tbody>
                {[
                  ...
                  <tr key={i}>
                    ...
                    >
                      <StatusBadge
                        status={item.type === "Increase" ? "active" : "voided"}
                        size="sm"
                      />
                    </td>
                    <td
