...
import { Pencil, Trash2, ArrowLeft, Landmark, Clock } from "lucide-react";

// ----------------------------------------------------------------------------
// Types
// ----------------------------------------------------------------------------
export interface BankDetailPageProps {
  bank?: Bank;
  onEdit?: () => void;
  onDelete?: () => void;
  onBack?: () => void;
      ...
      <div style={headerBannerStyle}>
        <div style={headerInfoStyle}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              <h2 style={headerNameStyle}>{currentBank.name}</h2>
              <span style={headerSubStyle}>
                {currentBank.shortName} &middot;{" "}
                {currentBank.isActive ? "Active" : "Inactive"}
              </span>
            </div>
          </div>
        </div>
        <StatusBadge status={currentBank.isActive ? "active" : "inactive"} />
      </div>

      {/* Bank Information Card */}
      <FormCard title="Bank Information" variant="teal-header">
        <div style={sectionStyle}>
          <h4 style={sectionTitleStyle}>Details</h4>
          <div style={gridStyle2}>
            {renderField("Name", currentBank.name)}
            {renderField("Short Name", currentBank.shortName)}
            {renderField("Status", currentBank.isActive ? "Active" : "Inactive")}
          </div>
        </div>
      </FormCard>
        ...
        >
          <div style={timelineItemStyle}>
            ...
            <div style={timelineContentStyle}>
              <span style={timelineTitleStyle}>Bank Created</span>
