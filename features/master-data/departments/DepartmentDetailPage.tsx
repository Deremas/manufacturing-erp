...
export default function DepartmentDetailPage({
  ...
  return (
    <div style={pageStyle}>
      ...
      <div style={headerBannerStyle}>
        <div style={headerInfoStyle}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div>
              <h2 style={headerNameStyle}>{currentDepartment.name}</h2>
              <span style={headerSubStyle}>
                {currentDepartment.code} &middot;{" "}
                {currentDepartment.isActive ? "Active" : "Inactive"}
              </span>
            </div>
          </div>
        </div>
        <StatusBadge status={currentDepartment.isActive ? "active" : "inactive"} />
      </div>

      {/* Department Information Card */}
      <FormCard title="Department Information" variant="teal-header">
        <div style={sectionStyle}>
          <h4 style={sectionTitleStyle}>Details</h4>
          <div style={gridStyle2}>
            {renderField("Name", currentDepartment.name)}
            {renderField("Code", currentDepartment.code)}
            {renderField(
              "Status",
              currentDepartment.isActive ? "Active" : "Inactive",
            )}
      ...
      <FormCard title="Manager Information" variant="teal-header">
        <div style={sectionStyle}>
          <h4 style={sectionTitleStyle}>Manager</h4>
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            <div
              style={{
                width: "40px",
            ...
            <div>
              ...
              {currentDepartment.managerId && (
                ...
                >
                  ID: {currentDepartment.managerId}
                </div>
              )}
            </div>
          </div>
        ...
        >
          <div style={timelineItemStyle}>
            ...
            <div style={timelineContentStyle}>
              <span style={timelineTitleStyle}>Department Created</span>
