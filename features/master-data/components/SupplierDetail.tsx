  ...
  return (
    ...
    >
      ...
      <div style={sectionStyle}>
        ...
        <div style={gridStyle}>
          {renderField("Supplier Code", supplier.supplierCode || "\u2014")}
          {renderField("Supplier Name", supplier.name)}
          {renderField("Status", statusBadge)}
          {renderField("Contact Person", supplier.contactPerson || "\u2014")}
        </div>
      </div>
      ...
      <div style={sectionStyle}>
        ...
        <div style={gridStyle}>
          {renderField("Phone", supplier.phone || "\u2014")}
      ...
      <div style={sectionStyle}>
        ...
        <div style={gridStyle}>
          {renderField("Payment Terms", supplier.paymentTerms || "\u2014")}
        </div>
      </div>
    </FormCard>
  );
