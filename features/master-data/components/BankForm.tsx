...
import { bankSchema } from "@/validators/master-data";
import type { BankInput } from "@/validators/master-data";
...
export default function BankForm({
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      >
        <div style={gridStyle}>
          {renderField("name", "Bank Name", "Enter bank name")}
          {renderField("shortName", "Short Name", "e.g. KCB")}
        </div>
