...
// Types
// ----------------------------------------------------------------------------
export interface TaxCodeDetailProps {
  taxCode: TaxCode;
  onEdit?: () => void;
  onDelete?: () => void;
  onBack?: () => void;
...
export default function TaxCodeDetail({
  ...
  const statusBadge = taxCode.isActive ? (
  ...
  return (
    ...
    >
      <div style={gridStyle}>
        {renderField("Tax Name", taxCode.taxName)}
        {renderField("Tax Type", taxCode.taxType || "\u2014")}
        {renderField("Rate", `${taxCode.rate}%`)}
